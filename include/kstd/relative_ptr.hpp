...
namespace kstd {
    ...
    struct RelativePtr final {
        ...
        constexpr auto operator =(T* value) noexcept -> self_type& {
            set(value);
            return *this;
        }

        constexpr auto set(T* value) noexcept -> void {
            _offset = static_cast<u32>(reinterpret_cast<u8*>(value) - reinterpret_cast<u8*>(this));
        }
